"""
Airport Construction Projects Agent
Specialized agent for aviation infrastructure projects
"""
...
from web_tool import AirportWebTool
import json

class AirportAgent:
    """Agent specialized in airport construction projects"""
    
    def __init__(self):
        self.name = "Airport Construction Agent"
        self.specialty = "Aviation Infrastructure"
        self.web_tool = AirportWebTool()
    ...
    def search_projects(self):
        """Search for airport construction projects"""
        print(f"\n{'='*80}")
    ...
    def extract_details(self, search_results):
        ...
        print("\n🤖 Extracting airport project details...")
        
        extraction_prompt = ChatPromptTemplate.from_messages([
            ("system", """You are an expert in aviation infrastructure projects.
            Extract DETAILED information about airport construction projects.
            Focus on: project name, airport name, location, budget, timeline, 
            contact information, contractor, terminal capacity, runway details."""),
    ...
    def run(self):
        """Run the complete airport agent workflow"""
        # Search
